...
#include "i_2Dof.h"
#include "main.h"
#include "i_2Dof_terminate.h"
#include "i_2Dof_initialize.h"

/* Function Declarations */
static void argInit_1x6_real32_T(float result[6]);
static float argInit_real32_T(void);
static void main_i_2Dof(void);
...
static void main_i_2Dof(void)
{
  ...
  /* Initialize function 'i_2Dof' input arguments. */
  /* Initialize function input argument 'Param'. */
  /* Call the entry-point 'i_2Dof'. */
  argInit_1x6_real32_T(fv0);
  i_2Dof(argInit_real32_T(), argInit_real32_T(), fv0, &Alpha1, &Alpha2);
}
