...
#ifndef MESSAGE__SRV__MOTORSEND__FUNCTIONS_H_
#define MESSAGE__SRV__MOTORSEND__FUNCTIONS_H_
...
/// Initialize srv/Motorsend message.
/**
...
/// Finalize srv/Motorsend message.
/**
...
/// Create srv/Motorsend message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message__srv__Motorsend_Request__init().
...
/// Destroy srv/Motorsend message.
/**
 * It calls
 * message__srv__Motorsend_Request__fini()
...
/// Initialize array of srv/Motorsend messages.
/**
...
/// Finalize array of srv/Motorsend messages.
/**
 * It calls
 * message__srv__Motorsend_Request__fini()
...
/// Create array of srv/Motorsend messages.
/**
 * It allocates the memory for the array and calls
 * message__srv__Motorsend_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Motorsend messages.
/**
 * It calls
 * message__srv__Motorsend_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * message__srv__Motorsend_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It calls
 * message__srv__Motorsend_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It allocates the memory for the array and calls
 * message__srv__Motorsend_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_message
...
/**
 * It calls
 * message__srv__Motorsend_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MESSAGE__SRV__MOTORSEND__FUNCTIONS_H_
