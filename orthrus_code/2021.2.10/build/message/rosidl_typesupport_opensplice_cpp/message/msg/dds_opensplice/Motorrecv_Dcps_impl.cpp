...
// DDS message::msg::dds_::Motorrecv_ TypeSupportMetaHolder Object Body
message::msg::dds_::Motorrecv_TypeSupportMetaHolder::Motorrecv_TypeSupportMetaHolder () :
        DDS::OpenSplice::TypeSupportMetaHolder ("message::msg::dds_::Motorrecv_", "", "")
{
    copyIn = (DDS::OpenSplice::cxxCopyIn) __message_msg_dds__Motorrecv___copyIn;
    copyOut = (DDS::OpenSplice::cxxCopyOut) __message_msg_dds__Motorrecv___copyOut;
    metaDescriptorArrLength = 3;
    metaDescriptorLength = 242;
    const char *tmp[] = {"<MetaData version=\"1.0.0\"><Module name=\"message\"><Module name=\"msg\"><Module name=\"dds_\"><Struct name=\"Motorrecv_\">",
...
message::msg::dds_::Motorrecv_TypeSupportMetaHolder::clone()
{
    return new message::msg::dds_::Motorrecv_TypeSupportMetaHolder();
}

::DDS::OpenSplice::DataWriter *
message::msg::dds_::Motorrecv_TypeSupportMetaHolder::create_datawriter ()
{
    return new message::msg::dds_::Motorrecv_DataWriter_impl();
}

::DDS::OpenSplice::DataReader *
message::msg::dds_::Motorrecv_TypeSupportMetaHolder::create_datareader ()
{
    return new message::msg::dds_::Motorrecv_DataReader_impl();
}

::DDS::OpenSplice::DataReaderView *
message::msg::dds_::Motorrecv_TypeSupportMetaHolder::create_view ()
{
    return new message::msg::dds_::Motorrecv_DataReaderView_impl();
}

// DDS message::msg::dds_::Motorrecv_ TypeSupport Object Body
message::msg::dds_::Motorrecv_TypeSupport::Motorrecv_TypeSupport () :
        DDS::OpenSplice::TypeSupport()
{
    tsMetaHolder = new message::msg::dds_::Motorrecv_TypeSupportMetaHolder();
}
...
// DDS message::msg::dds_::Motorrecv_ DataWriter_impl Object Body
message::msg::dds_::Motorrecv_DataWriter_impl::Motorrecv_DataWriter_impl ()
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::init (
...
message::msg::dds_::Motorrecv_DataWriter_impl::register_instance (
    const message::msg::dds_::Motorrecv_ & instance_data) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataWriter_impl::register_instance(&instance_data);
}

::DDS::InstanceHandle_t
message::msg::dds_::Motorrecv_DataWriter_impl::register_instance_w_timestamp (
    const Motorrecv_ & instance_data,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::unregister_instance (
    const message::msg::dds_::Motorrecv_ & instance_data,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::unregister_instance_w_timestamp (
    const Motorrecv_ & instance_data,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::write (
    const message::msg::dds_::Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::write_w_timestamp (
    const Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::dispose (
    const message::msg::dds_::Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::dispose_w_timestamp (
    const Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::writedispose (
    const message::msg::dds_::Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::writedispose_w_timestamp (
    const Motorrecv_ & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataWriter_impl::get_key_value (
    Motorrecv_ & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
message::msg::dds_::Motorrecv_DataWriter_impl::lookup_instance (
    const message::msg::dds_::Motorrecv_ & instance_data) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataWriter_impl::lookup_instance(&instance_data);
}

// DDS message::msg::dds_::Motorrecv_ DataReader_impl Object Body
message::msg::dds_::Motorrecv_DataReader_impl::Motorrecv_DataReader_impl ()
{
    // Parent constructor takes care of everything.
}
...
DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::init (
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read (
    message::msg::dds_::Motorrecv_Seq & received_data,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read_next_sample (
    message::msg::dds_::Motorrecv_ & received_data,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take_next_sample (
    message::msg::dds_::Motorrecv_ & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read_next_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take_next_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::read_next_instance_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::take_next_instance_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::return_loan (
    message::msg::dds_::Motorrecv_Seq & received_data,
        ...
        if ( received_data.length() > 0 ) {
            if (received_data.length() == info_seq.length() &&
                ...
                if (!received_data.release()) {
                    ...
                    if ( result == ::DDS::RETCODE_OK ) {
                        if ( !received_data.release() ) {
                            message::msg::dds_::Motorrecv_Seq::freebuf( received_data.get_buffer(false) );
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::get_key_value (
    message::msg::dds_::Motorrecv_ & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
message::msg::dds_::Motorrecv_DataReader_impl::lookup_instance (
    const message::msg::dds_::Motorrecv_ & instance) THROW_ORB_EXCEPTIONS
{
    return DDS::OpenSplice::FooDataReader_impl::lookup_instance(&instance);
}

::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReader_impl::check_preconditions (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples)
{
...
void *
message::msg::dds_::Motorrecv_DataReader_impl::dataSeqAlloc (
    void * received_data,
    DDS::ULong len)
{
    message::msg::dds_::Motorrecv_Seq *data_seq = reinterpret_cast<message::msg::dds_::Motorrecv_Seq *>(received_data);
    data_seq->replace(len, len, data_seq->allocbuf(len), false);
    return data_seq->get_buffer();
}

void *
message::msg::dds_::Motorrecv_DataReader_impl::dataSeqGetBuffer (
    void * received_data,
    DDS::ULong index)
{
	message::msg::dds_::Motorrecv_Seq *data_seq = reinterpret_cast<message::msg::dds_::Motorrecv_Seq *>(received_data);
...
void
message::msg::dds_::Motorrecv_DataReader_impl::dataSeqLength (
    void * received_data,
    DDS::ULong len)
{
    message::msg::dds_::Motorrecv_Seq *data_seq = reinterpret_cast<message::msg::dds_::Motorrecv_Seq *>(received_data);
...
void
message::msg::dds_::Motorrecv_DataReader_impl::dataSeqCopyOut (
    const void * from,
    void * to)
{
    message::msg::dds_::Motorrecv_ *data = reinterpret_cast<message::msg::dds_::Motorrecv_ *>(to);
    __message_msg_dds__Motorrecv___copyOut(from, data);
}

void
message::msg::dds_::Motorrecv_DataReader_impl::copyDataOut (
    const void * from,
    void * to)
{
    message::msg::dds_::Motorrecv_ *data = reinterpret_cast<message::msg::dds_::Motorrecv_ *>(to);
...
// DDS message::msg::dds_::Motorrecv_ DataReaderView_impl Object Body
message::msg::dds_::Motorrecv_DataReaderView_impl::Motorrecv_DataReaderView_impl ()
{
    // Parent constructor takes care of everything.
}
...
DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::init (
    ...
    DDS::OpenSplice::cxxCopyOut copyOut)
{
    return DDS::OpenSplice::FooDataReaderView_impl::nlReq_init(
            reader, name, qos, copyIn, copyOut, message::msg::dds_::Motorrecv_DataReader_impl::dataSeqAlloc,
            message::msg::dds_::Motorrecv_DataReader_impl::dataSeqLength);
}

::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
    ...
    ::DDS::InstanceStateMask instance_states) THROW_ORB_EXCEPTIONS
{
    ...
    status = message::msg::dds_::Motorrecv_DataReader_impl::check_preconditions(received_data, info_seq, max_samples);
    if ( status == ::DDS::RETCODE_OK ) {
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read_next_sample (
    message::msg::dds_::Motorrecv_ & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take_next_sample (
    message::msg::dds_::Motorrecv_ & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read_next_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take_next_instance (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::read_next_instance_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::take_next_instance_w_condition (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::return_loan (
    message::msg::dds_::Motorrecv_Seq & received_data,
    ::DDS::SampleInfoSeq & info_seq) THROW_ORB_EXCEPTIONS
{
    ::DDS::ReturnCode_t result = ::DDS::RETCODE_OK;
...
::DDS::ReturnCode_t
message::msg::dds_::Motorrecv_DataReaderView_impl::get_key_value (
    message::msg::dds_::Motorrecv_ & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
message::msg::dds_::Motorrecv_DataReaderView_impl::lookup_instance (
    const message::msg::dds_::Motorrecv_ & instance) THROW_ORB_EXCEPTIONS
{
