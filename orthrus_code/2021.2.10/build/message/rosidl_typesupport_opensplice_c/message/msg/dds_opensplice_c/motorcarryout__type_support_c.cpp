...
convert_dds_to_ros_message__msg__Motorcarryout(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: mode_lf_1
  {
    ros_message->mode_lf_1 = dds_message->mode_lf_1_;
  }

  // Field name: t_lf_1
  {
    ros_message->t_lf_1 = dds_message->t_lf_1_;
  }

  // Field name: w_lf_1
  {
    ros_message->w_lf_1 = dds_message->w_lf_1_;
  }

  // Field name: pos_lf_1
  {
    ros_message->pos_lf_1 = dds_message->pos_lf_1_;
  }

  // Field name: k_p_lf_1
  {
    ros_message->k_p_lf_1 = dds_message->k_p_lf_1_;
  }

  // Field name: k_w_lf_1
  {
    ros_message->k_w_lf_1 = dds_message->k_w_lf_1_;
  }

  // Field name: mode_lf_2
  {
    ros_message->mode_lf_2 = dds_message->mode_lf_2_;
  }

  // Field name: t_lf_2
  {
    ros_message->t_lf_2 = dds_message->t_lf_2_;
  }

  // Field name: w_lf_2
  {
    ros_message->w_lf_2 = dds_message->w_lf_2_;
  }

  // Field name: pos_lf_2
  {
    ros_message->pos_lf_2 = dds_message->pos_lf_2_;
  }

  // Field name: k_p_lf_2
  {
    ros_message->k_p_lf_2 = dds_message->k_p_lf_2_;
  }

  // Field name: k_w_lf_2
  {
    ros_message->k_w_lf_2 = dds_message->k_w_lf_2_;
  }

  // Field name: mode_lf_3
  {
    ros_message->mode_lf_3 = dds_message->mode_lf_3_;
  }

  // Field name: t_lf_3
  {
    ros_message->t_lf_3 = dds_message->t_lf_3_;
  }

  // Field name: w_lf_3
  {
    ros_message->w_lf_3 = dds_message->w_lf_3_;
  }

  // Field name: pos_lf_3
  {
    ros_message->pos_lf_3 = dds_message->pos_lf_3_;
  }

  // Field name: k_p_lf_3
  {
    ros_message->k_p_lf_3 = dds_message->k_p_lf_3_;
  }

  // Field name: k_w_lf_3
  {
    ros_message->k_w_lf_3 = dds_message->k_w_lf_3_;
  }

  // Field name: mode_rf_1
  {
    ros_message->mode_rf_1 = dds_message->mode_rf_1_;
  }

  // Field name: t_rf_1
  {
    ros_message->t_rf_1 = dds_message->t_rf_1_;
  }

  // Field name: w_rf_1
  {
    ros_message->w_rf_1 = dds_message->w_rf_1_;
  }

  // Field name: pos_rf_1
  {
    ros_message->pos_rf_1 = dds_message->pos_rf_1_;
  }

  // Field name: k_p_rf_1
  {
    ros_message->k_p_rf_1 = dds_message->k_p_rf_1_;
  }

  // Field name: k_w_rf_1
  {
    ros_message->k_w_rf_1 = dds_message->k_w_rf_1_;
  }

  // Field name: mode_rf_2
  {
    ros_message->mode_rf_2 = dds_message->mode_rf_2_;
  }

  // Field name: t_rf_2
  {
    ros_message->t_rf_2 = dds_message->t_rf_2_;
  }

  // Field name: w_rf_2
  {
    ros_message->w_rf_2 = dds_message->w_rf_2_;
  }

  // Field name: pos_rf_2
  {
    ros_message->pos_rf_2 = dds_message->pos_rf_2_;
  }

  // Field name: k_p_rf_2
  {
    ros_message->k_p_rf_2 = dds_message->k_p_rf_2_;
  }

  // Field name: k_w_rf_2
  {
    ros_message->k_w_rf_2 = dds_message->k_w_rf_2_;
  }

  // Field name: mode_rf_3
  {
    ros_message->mode_rf_3 = dds_message->mode_rf_3_;
  }

  // Field name: t_rf_3
  {
    ros_message->t_rf_3 = dds_message->t_rf_3_;
  }

  // Field name: w_rf_3
  {
    ros_message->w_rf_3 = dds_message->w_rf_3_;
  }

  // Field name: pos_rf_3
  {
    ros_message->pos_rf_3 = dds_message->pos_rf_3_;
  }

  // Field name: k_p_rf_3
  {
    ros_message->k_p_rf_3 = dds_message->k_p_rf_3_;
  }

  // Field name: k_w_rf_3
  {
    ros_message->k_w_rf_3 = dds_message->k_w_rf_3_;
  }

  // Field name: mode_lb_1
  {
    ros_message->mode_lb_1 = dds_message->mode_lb_1_;
  }

  // Field name: t_lb_1
  {
    ros_message->t_lb_1 = dds_message->t_lb_1_;
  }

  // Field name: w_lb_1
  {
    ros_message->w_lb_1 = dds_message->w_lb_1_;
  }

  // Field name: pos_lb_1
  {
    ros_message->pos_lb_1 = dds_message->pos_lb_1_;
  }

  // Field name: k_p_lb_1
  {
    ros_message->k_p_lb_1 = dds_message->k_p_lb_1_;
  }

  // Field name: k_w_lb_1
  {
    ros_message->k_w_lb_1 = dds_message->k_w_lb_1_;
  }

  // Field name: mode_lb_2
  {
    ros_message->mode_lb_2 = dds_message->mode_lb_2_;
  }

  // Field name: t_lb_2
  {
    ros_message->t_lb_2 = dds_message->t_lb_2_;
  }

  // Field name: w_lb_2
  {
    ros_message->w_lb_2 = dds_message->w_lb_2_;
  }

  // Field name: pos_lb_2
  {
    ros_message->pos_lb_2 = dds_message->pos_lb_2_;
  }

  // Field name: k_p_lb_2
  {
    ros_message->k_p_lb_2 = dds_message->k_p_lb_2_;
  }

  // Field name: k_w_lb_2
  {
    ros_message->k_w_lb_2 = dds_message->k_w_lb_2_;
  }

  // Field name: mode_lb_3
  {
    ros_message->mode_lb_3 = dds_message->mode_lb_3_;
  }

  // Field name: t_lb_3
  {
    ros_message->t_lb_3 = dds_message->t_lb_3_;
  }

  // Field name: w_lb_3
  {
    ros_message->w_lb_3 = dds_message->w_lb_3_;
  }

  // Field name: pos_lb_3
  {
    ros_message->pos_lb_3 = dds_message->pos_lb_3_;
  }

  // Field name: k_p_lb_3
  {
    ros_message->k_p_lb_3 = dds_message->k_p_lb_3_;
  }

  // Field name: k_w_lb_3
  {
    ros_message->k_w_lb_3 = dds_message->k_w_lb_3_;
  }

  // Field name: mode_rb_1
  {
    ros_message->mode_rb_1 = dds_message->mode_rb_1_;
  }

  // Field name: t_rb_1
  {
    ros_message->t_rb_1 = dds_message->t_rb_1_;
  }

  // Field name: w_rb_1
  {
    ros_message->w_rb_1 = dds_message->w_rb_1_;
  }

  // Field name: pos_rb_1
  {
    ros_message->pos_rb_1 = dds_message->pos_rb_1_;
  }

  // Field name: k_p_rb_1
  {
    ros_message->k_p_rb_1 = dds_message->k_p_rb_1_;
  }

  // Field name: k_w_rb_1
  {
    ros_message->k_w_rb_1 = dds_message->k_w_rb_1_;
  }

  // Field name: mode_rb_2
  {
    ros_message->mode_rb_2 = dds_message->mode_rb_2_;
  }

  // Field name: t_rb_2
  {
    ros_message->t_rb_2 = dds_message->t_rb_2_;
  }

  // Field name: w_rb_2
  {
    ros_message->w_rb_2 = dds_message->w_rb_2_;
  }

  // Field name: pos_rb_2
  {
    ros_message->pos_rb_2 = dds_message->pos_rb_2_;
  }

  // Field name: k_p_rb_2
  {
    ros_message->k_p_rb_2 = dds_message->k_p_rb_2_;
  }

  // Field name: k_w_rb_2
  {
    ros_message->k_w_rb_2 = dds_message->k_w_rb_2_;
  }

  // Field name: mode_rb_3
  {
    ros_message->mode_rb_3 = dds_message->mode_rb_3_;
  }

  // Field name: t_rb_3
  {
    ros_message->t_rb_3 = dds_message->t_rb_3_;
  }

  // Field name: w_rb_3
  {
    ros_message->w_rb_3 = dds_message->w_rb_3_;
  }

  // Field name: pos_rb_3
  {
    ros_message->pos_rb_3 = dds_message->pos_rb_3_;
  }

  // Field name: k_p_rb_3
  {
    ros_message->k_p_rb_3 = dds_message->k_p_rb_3_;
  }

  // Field name: k_w_rb_3
  {
    ros_message->k_w_rb_3 = dds_message->k_w_rb_3_;
  }
